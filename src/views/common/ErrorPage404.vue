<template>
    <div id="main" class="main_body">
      ...
      <div>
        ...
        <span class="text">
            <router-link class="go_home" to="/">
            <b class="text">return&nbsp;home?</b>
            </router-link>
        </span>
        </div>
      </div>
...
.go_home:hover b, .go_home:focus b {
  color: #F04F54;
}
.go_home:active b {
  color: #43CB9D;
...
.main_body > div:first-child span:first-child {
  opacity: 0;
...
.main_body > div:first-child span:last-child {
  opacity: 0;
  -webkit-transform: translateX(100%);
          transform: translateX(100%);
...
.main_body > div:first-child svg polygon {
...
.main_body > div:last-child span:first-child {
  opacity: 0;
  -webkit-transform: translateX(-100%);
          transform: translateX(-100%);
...
.main_body > div:last-child span:last-child {
  opacity: 0;
  -webkit-transform: translateX(-100%);
          transform: translateX(-100%);
